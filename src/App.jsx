...
const App = () => {
  return (
    <Routes>
      ...
      <Route
        path="/H7-rip-k-Lg"
        element={<RedirectToExternal url="https://www.redbubble.com/shop/ap/170578990" />}
      />
      
      <Route
        path="/A1-a.-i.-D.-lg"
        element={<RedirectToExternal url="https://www.redbubble.com/shop/ap/170556424" />}
      />

      <Route
        path="/C3-Y-T-L-L-Lg"
        element={<RedirectToExternal url="https://www.redbubble.com/shop/ap/170409688" />}
      />
      <Route
